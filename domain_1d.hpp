...
class Domain1D
{
    ...
    =========
    domain_in : Domain3D
        3D domain where this 1D domain can be found.
    ...
    */
    ...
    // 3D domain where this 1D domain is found
    Domain3D* domain_ptr;
    ...
    // constructor
    Domain1D(Domain3D &domain_in, std::string file_in_element_str_in)
    {
...
void Domain1D::extract_domain_point()
{
