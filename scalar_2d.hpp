...
class Scalar2D
{
    ...
    */
    ...
    Scalar2D(Domain2D &domain_in, double value_constant_in)
    {
    ...
    Scalar2D(Domain2D &domain_in, std::function<double(double, double, double, VectorDouble)> value_function_in, std::vector<Variable3D*> variable_ptr_vec_in)
    {
...
void Scalar2D::set_output(std::string file_out_str)
{
    /*
...
void Scalar2D::output_csv(int ts)
{
    /*
...
VectorDouble Scalar2D::get_neighbor_value(int edid)
{
    /*
