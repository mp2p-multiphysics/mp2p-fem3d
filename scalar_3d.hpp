...
class Scalar3D
{
    ...
    */
    ...
    Scalar3D(Domain3D &domain_in, double value_constant_in)
    {
    ...
    Scalar3D(Domain3D &domain_in, std::function<double(double, double, double, VectorDouble)> value_function_in, std::vector<Variable3D*> variable_ptr_vec_in)
    {
...
void Scalar3D::set_output(std::string file_out_str)
{
    /*
...
void Scalar3D::output_csv(int ts)
{
    /*
...
void Scalar3D::update_value()
{
    ...
    */
    ...
    for (int pdid = 0; pdid < domain_ptr->num_point; pdid++)
    {
        ...
        double position_z = domain_ptr->point_position_y_vec[pdid];
...
VectorDouble Scalar3D::get_neighbor_value(int edid)
{
    /*
