...
class PhysicsTransientConvectionDiffusion : public PhysicsTransientBase
{
    ...
    */
    ...
    void set_domain(Domain2D &domain_in, Integral2D &integral_in, Scalar2D &derivativecoefficient_in, Scalar2D &diffusioncoefficient_in, Scalar2D &velocity_x_in, Scalar2D &velocity_y_in, Scalar2D &generationcoefficient_in);
    ...
    (
        ...
        Scalar2D *derivativecoefficient_ptr, Scalar2D *diffusioncoefficient_ptr, Scalar2D *velocity_x_ptr, Scalar2D *velocity_y_ptr, Scalar2D *generationcoefficient_ptr
    );
...
void PhysicsTransientConvectionDiffusion::set_domain(Domain2D &domain_in, Integral2D &integral_in, Scalar2D &derivativecoefficient_in, Scalar2D &diffusioncoefficient_in, Scalar2D &velocity_x_in, Scalar2D &velocity_y_in, Scalar2D &generationcoefficient_in)
{
    /*
...
void PhysicsTransientConvectionDiffusion::set_boundary_dirichlet(Domain1D &domain_in, Scalar1D &value_constant_in)
{
    /*
...
void PhysicsTransientConvectionDiffusion::set_boundary_neumann(Domain1D &domain_in, Integral1D &integral_in, Scalar1D &value_flux_in)
{
    /*
