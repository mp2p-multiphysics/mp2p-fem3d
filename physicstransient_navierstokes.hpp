...
class PhysicsTransientNavierStokes : public PhysicsTransientBase
{
    ...
    */
    ...
    // constructor
    PhysicsTransientNavierStokes(VariableGroup &velocity_x_in, VariableGroup &velocity_y_in, VariableGroup &velocity_z_in, VariableGroup &pressure_in)
    {
...
)
{
    ...
    */
    ...
    for (int indx_d = 0; indx_d < domain_line_ptr_vec.size(); indx_d++)
    {
        ...
        matrix_fill_domain(a_trivec, c_trivec, d_vec, x_vec, x_last_timestep_vec, dt, domain_line_ptr, domain_quad_ptr, integral_ptr, density_ptr, viscosity_ptr, force_x_ptr, force_y_ptr, force_z_ptr);
    ...
    for (int indx_d = 0; indx_d < velocity_domain_ptr_vec.size(); indx_d++)
    {
        ...
        matrix_fill_velocity(a_trivec, c_trivec, d_vec, x_vec, x_last_timestep_vec, dt, domain_ptr, velocity_x_ptr, velocity_y_ptr, velocity_z_ptr);
    }
