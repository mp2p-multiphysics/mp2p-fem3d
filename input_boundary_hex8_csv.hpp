#ifndef INPUT_BOUNDARY_HEX8_CSV
#define INPUT_BOUNDARY_HEX8_CSV
#include <sstream>
#include <fstream>
#include <vector>
#include "grid_hex8.hpp"

BoundaryHex8Struct input_boundary_hex8_csv(std::string file_in_flux_str, std::string file_in_value_str, std::string file_in_config_str)
{
    ...
    while (std::getline(file_in_flux_stream, line_flux_str))
    {
        ...
        while (std::getline(line_flux_stream, value_flux_str, ','))
        {
            ...
            {
                case 0: bh8s.element_flux_id_vec.push_back(std::stoi(value_flux_str)); break;
                case 1: bh8s.element_flux_pa_loc_vec.push_back(std::stoi(value_flux_str)); break;
                case 2: bh8s.element_flux_pb_loc_vec.push_back(std::stoi(value_flux_str)); break;
                case 3: bh8s.element_flux_pc_loc_vec.push_back(std::stoi(value_flux_str)); break;
                case 4: bh8s.element_flux_pd_loc_vec.push_back(std::stoi(value_flux_str)); break;
                case 5: bh8s.element_flux_config_id_vec.push_back(std::stoi(value_flux_str)); break;
            }
    ...
    while (std::getline(file_in_value_stream, line_value_str))
    {
        ...
        while (std::getline(line_value_stream, value_value_str, ','))
        {
            ...
            {
                case 0: bh8s.element_value_id_vec.push_back(std::stoi(value_value_str)); break;
                case 1: bh8s.element_value_pa_loc_vec.push_back(std::stoi(value_value_str)); break;
                case 2: bh8s.element_value_pb_loc_vec.push_back(std::stoi(value_value_str)); break;
                case 3: bh8s.element_value_pc_loc_vec.push_back(std::stoi(value_value_str)); break;
                case 4: bh8s.element_value_pd_loc_vec.push_back(std::stoi(value_value_str)); break;
                case 5: bh8s.element_value_config_id_vec.push_back(std::stoi(value_value_str)); break;
            }
    ...
    BoundaryConfigHex8Struct bch8s_sub;  // temporarily stores BoundaryTypeData for insertion into bh8s
    BoundaryConfigHex8Struct bch8s_new;  // new copy of BoundaryTypeData object
    ...
    while (std::getline(file_in_config_stream, line_config_str))
    {
        ...
        while (std::getline(line_config_stream, subline_config_str, ' '))
        {
            ...
            if (is_config_next)
            {
                ...
                bch8s_sub.boundary_type_str = subline_config_str;
            ...
            if (is_value_next)
            {
                ...
                {
                    bch8s_sub.boundary_parameter_vec.push_back(std::stod(value_config_str));
                }

                // store BoundaryTypeData object
                bh8s.boundary_config_vec.push_back(bch8s_sub);
                bch8s_sub = bch8s_new;  // clears bch8s_sub
